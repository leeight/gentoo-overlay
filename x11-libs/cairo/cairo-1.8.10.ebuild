...
src_prepare() {
	...
	# Patch from ubuntu lucid
	epatch "${FILESDIR}/01_no-private-symbol-export.patch"
	epatch "${FILESDIR}/04_lcd_filter.patch"
	epatch "${FILESDIR}/06_Xlib-Xcb-Hand-off-EXTEND_PAD-to-XRender.patch"
